...
public abstract class GraphicsViewBase extends SurfaceView implements
	...
	private Thread mGraphicsRunThread;
	...
	public void surfaceChanged(SurfaceHolder _holder, int format, int width,
		...
		if (mCamera != null) {
			...
			mGraphicsRunThread = (new Thread(this));
			mGraphicsRunThread.start();
		}
	}
